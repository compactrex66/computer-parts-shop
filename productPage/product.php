...
<body>
    ...
    <div class="itemPage">
        <div class="row">
            ...
            ?>
            <div class="buyPanel">
                <?php echo $result[2]."$"; echo "<span id=productId style='display: none;'>".$result[0]."</span>" ?>
                <div class="quantity">
                    <div class="quantityChoice"><button id="decreaseQuantity"><</button> <span id="quantity">1</span> <button id="increaseQuantity">></button></div>
                    <div class="quantityText">quantity <span>|</span> <?php echo "<span id='inStock'>".$result[6]."</span>".' in stock' ?> </div>
                </div>
