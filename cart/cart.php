...
<body>
    ...
    <div class="cart">
        ...
        <div class="summary">
            <?php 
            echo "<div class='summaryText'><span>Całkowity Koszt:</span><span>$totalCost zł</span></div>" ?>
            <button id="goToPaymentBtn">Idź do zapłaty</button>
            <button id="removeCartItemsBtn">Usuń wszystko</button>
        </div>
    </div>
